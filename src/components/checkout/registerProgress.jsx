...
function Citiesmap() {
  const citieslist = [
    ...
    { id: 26, name: "臺東縣", value: "TT" },
    { id: 27, name: "澎湖縣", value: "PEH" },
    { id: 28, name: "金門縣", value: "KMN" },
    { id: 29, name: "連江縣", value: "LNN" },
  ];

  const Allmap = citieslist.map((city) => (
    <option key={city.id} code={city.value}>
      {city.name}
    </option>
  ));
  return <select id="client_city">{Allmap}</select>;
}
